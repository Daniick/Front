...
const Header = () => {
  return (
    <header className="flex justify-between h-[7vh] md:h-[10vh] border-b border-secondary-100 p-8 items-center bg-[#505c68]">

      
      {/* Agregamos los botones Lista y Artículos */}
      <div className="flex items-center justify-between gap-8 text-white ">
        <button className="text-black transition-colors btn hover:text-gray-400">Lista</button>
        <button className="text-black transition-colors btn hover:text-gray-400">Artículos</button>
        <button className="text-black transition-colors btn hover:text-gray-400">Elementos</button>
      </div>
        ...
        <Menu
          menuButton={
            <MenuButton className="flex items-center p-2 transition-colors rounded-lg gap-x-2 hover:bg-red-100">
              ...
              />
              <span className="text-black">Grupo 22222</span>
              <RiArrowDownSLine />
            </MenuButton>
          }
          align="end"
